...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({LeaveBalanceException.class, LeaveApplicationException.class, BadRequestException.class})
    ...
    public ResponseEntity<ApiResponse<Object>> handlePayrollConflict(PayrollAlreadyProcessedException ex) {
