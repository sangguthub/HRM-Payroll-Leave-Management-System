...
import { LogIn, Lock, Mail, ShieldCheck, UserCheck, Briefcase, Building2, CheckCircle2 } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-md w-full glass-card-dark rounded-3xl shadow-2xl overflow-hidden relative z-10">
        {/* Header Banner */}
        ...
        <div className="p-8 space-y-6">
          {error && (
            <div className="p-3.5 bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs rounded-xl font-semibold flex items-center gap-2">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-900/80 border border-slate-700/80 text-white rounded-xl text-sm placeholder-slate-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition"
                  required
                />
              </div>
            </div>
          ...
          <div className="border-t border-slate-800 pt-5 space-y-3">
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest text-center">Demo Quick Login Credentials</p>

            <div className="grid grid-cols-3 gap-2.5">
              <button
                type="button"
                onClick={() => handleQuickLogin('admin@hrm.com', 'Admin@123')}
                className="p-2.5 bg-slate-900/90 hover:bg-slate-800 border border-slate-700 text-slate-200 rounded-xl text-xs font-semibold flex flex-col items-center gap-1 transition group"
              >
                <ShieldCheck size={16} className="text-indigo-400 group-hover:scale-110 transition" /> Admin
              </button>
              ...
              <button
                ...
                className="p-2.5 bg-slate-900/90 hover:bg-slate-800 border border-slate-700 text-slate-200 rounded-xl text-xs font-semibold flex flex-col items-center gap-1 transition group"
              >
                <Briefcase size={16} className="text-blue-400 group-hover:scale-110 transition" /> HR Manager
              </button>
              ...
              <button
                ...
                className="p-2.5 bg-slate-900/90 hover:bg-slate-800 border border-slate-700 text-slate-200 rounded-xl text-xs font-semibold flex flex-col items-center gap-1 transition group"
              >
                <UserCheck size={16} className="text-emerald-400 group-hover:scale-110 transition" /> Employee
              </button>
            </div>
          </div>
        </div>
